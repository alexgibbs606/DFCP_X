...
ctld.maximumDistanceLogistic = 600 -- max distance from vehicle to logistics to allow a loading or spawning operation
...
ctld.enableFastRopeInsertion = false -- allows you to drop troops by fast rope
...
ctld.deployedBeaconBattery = 180 -- the battery on deployed beacons will last for this number minutes before needing to be re-deployed
...
ctld.pickupZones = {
    ...
    { "Tarawa", "none", -1, "yes", 0}, -- instead of a Zone Name you can also use the UNIT NAME of a ship
    { "Washington", "none", -1, "yes", 0}, -- instead of a Zone Name you can also use the UNIT NAME of a ship
}
